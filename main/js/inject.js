...
let util = {
    ...
    // 链接标识
    getUrlType() {
        let list = [{ match: /danbooru\.donmai\.us\/posts/, type: 'danbooru' }, { match: /danbooru\.donmai\.us\/pools/, type: 'danbooru' }, { match: /yande.re\/post/, type: 'yande.re' }, { match: /yande.re\/pool/, type: 'yande.re.pool' }, { match: /baidu.com/, type: 'baidu' }, { match: /www.acfun.cn\/a\//, type: 'acfun' }, { match: /localhost/, type: 'localhost' }, { match: /ichi\-up\.net\//, type: 'ichi-up' }, { match: /bing\.ioliu\.cn/, type: 'bing' }, { match: /gbf\.huijiwiki\.com\/wiki/, type: 'gbf' }, // gbf维基
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__store_store_js__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__widgets_widgets__ = __webpack_require__(15);
/*
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dialog_vue__ = __webpack_require__(32);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'app',
  components: {
    downloadDialog: __WEBPACK_IMPORTED_MODULE_0__dialog_vue___default.a
  },
  data() {
    return {};
  },
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted() {
    var clipboard = new __WEBPACK_IMPORTED_MODULE_0_clipboard___default.a('.' + this.tag, {
      text: () => {
        return this.url;
      }
    });
...
/* harmony default export */ __webpack_exports__["a"] = ({
    // 待获取图片列表
    list: [/* 'https://imgs.aixifan.com/FobKgtlLYWR5EMmd2NKD3lU5raZK', 'https://imgs.aixifan.com/FppAAoc87oY9Q34qmH0j0IOlF_W_' */],
    errorList: [],
    successList: [],
    pool: 'pool'
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_html2canvas__ = __webpack_require__(26);
...
const store = {
    ...
    getters: {
        queryObj() {
            return __WEBPACK_IMPORTED_MODULE_0__util_js__["a" /* default */].getQueryString();
        }
    },
    // -----------------------------------------------------------------------------------------------------------
    mutations: {
    ...
    actions: {
        ...
        init({ state, commit, dispatch, getters }) {
            ...
            let queryString = __WEBPACK_IMPORTED_MODULE_0__util_js__["a" /* default */].getQueryString(search);
            // alert(origin);
            state.urlType = __WEBPACK_IMPORTED_MODULE_0__util_js__["a" /* default */].getUrlType();
            ...
            document.body.addEventListener('drop', e => {
                ...
                if (file && file[0]) {
                    ...
                    } else if (__WEBPACK_IMPORTED_MODULE_0__util_js__["a" /* default */].endWidth(file[0].name, '.txt')) {
                        let fileReader = new FileReader();
                        fileReader.readAsText(file[0]);
                        fileReader.onload = () => {
                            let jsonText = fileReader.result;
            ...
            return new Promise((resolve, reject) => {
                ...
                if (state.urlType == 'danbooru') {
                    ...
                    jq('.photo_cont .ph_ar_box').each((index, item) => {
                        ...
                        console.log(index);
                        let qs = __WEBPACK_IMPORTED_MODULE_0__util_js__["a" /* default */].getQueryString(decodeURIComponent(actionData));
                        console.log(qs);
                    ...
                    if (state.list.length > 0) {
                        try {
                            ...
                            if (state.urlType == 'danbooru' && location.href.indexOf('pools') > -1) {
                                ...
                                fileName = state.tags.replace('er.', 'er') + '/' + state.imgMapTag[url] + '.' + __WEBPACK_IMPORTED_MODULE_0__util_js__["a" /* default */].getExt(url);
                            } else if (state.urlType == 'hobby') {
                            ...
                            return;  */
                            console.log('fileName', fileName);
                            fileName = __WEBPACK_IMPORTED_MODULE_0__util_js__["a" /* default */].checkName(fileName);
                            // alert(state.urlType);
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = install;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__taskitem_vue__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__taskitem_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__taskitem_vue__);

function install(Vue) {
	Vue.component('taskitem', __WEBPACK_IMPORTED_MODULE_0__taskitem_vue___default.a);
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__snackbar_snackbar__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__taskitem_taskitem__ = __webpack_require__(14);
...
const options = {
    ...
    taskitem: __WEBPACK_IMPORTED_MODULE_1__taskitem_taskitem__["a" /* default */]
};
options.install = Vue => {
...
(function () {
	...
	var injectUtil = {
		...
		descUrl: function () {
			...
			if (href.indexOf('detail.1688.com') > -1) {
				// 1688
	...
	if (href.indexOf('wbExtensions') > -1) {
		...
		} else if (href.indexOf('yangkeduo.com/goods') > -1) {
			// 拼多多 目前没有要通过特殊处理才能拿到数据的数据就在html 页面上，所以直接通过httpRequest拿取会比较好
			var html = document.getElementsByTagName('html')[0].innerHTML;
	...
	window.wonbaoInjectedObj.receiveTaskFetchHtmlAndDesc = function () {
		...
		var matches = ['https://detail.tmall.com/', //天猫 （可以拿到详情）
		...
		'https://m.1688.com/'];
		if (locationHref.indexOf(matches[0]) > -1 || locationHref.indexOf(matches[1]) > -1 || locationHref.indexOf(matches[2]) > -1 || locationHref.indexOf(matches[3]) > -1 || locationHref.indexOf(matches[4]) > -1 || locationHref.indexOf(matches[5]) > -1) {
	...
	if (window.jq) {
		...
		jq(function () {
			...
			if (location.href.indexOf('localhost') > -1 || location.href.indexOf('wonbao') > -1 || location.href.indexOf('file:') > -1 || location.href.indexOf('192.168') > -1 || location.href.indexOf('bilibili') > -1) {
...
// module
exports.push([module.i, "#host-e-view{width:0;height:0;left:0;top:0;position:absolute;z-index:100000}.download-btn{width:30px;height:35px;line-height:35px;color:#fff;border-radius:3px 0 0 3px;background-color:#007acc;position:fixed;right:0;top:200px;cursor:pointer;text-align:center}", ""]);
...
// module
exports.push([module.i, ".icon-copy{display:inline-block;background-image:url(\"data:image/svg+xml;charset=utf-8,%3Csvg class='icon' viewBox='0 0 1024 1024' xmlns='http://www.w3.org/2000/svg' width='200' height='200'%3E%3Cpath d='M574 665.4c-3.1-3.1-8.2-3.1-11.3 0L446.5 781.6c-53.8 53.8-144.6 59.5-204 0-59.5-59.5-53.8-150.2 0-204l116.2-116.2c3.1-3.1 3.1-8.2 0-11.3l-39.8-39.8c-3.1-3.1-8.2-3.1-11.3 0L191.4 526.5c-84.6 84.6-84.6 221.5 0 306s221.5 84.6 306 0l116.2-116.2c3.1-3.1 3.1-8.2 0-11.3L574 665.4zm258.6-474c-84.6-84.6-221.5-84.6-306 0L410.3 307.6c-3.1 3.1-3.1 8.2 0 11.3l39.7 39.7c3.1 3.1 8.2 3.1 11.3 0l116.2-116.2c53.8-53.8 144.6-59.5 204 0 59.5 59.5 53.8 150.2 0 204L665.3 562.6c-3.1 3.1-3.1 8.2 0 11.3l39.8 39.8c3.1 3.1 8.2 3.1 11.3 0l116.2-116.2c84.5-84.6 84.5-221.5 0-306.1zM610.1 372.3c-3.1-3.1-8.2-3.1-11.3 0L372.3 598.7c-3.1 3.1-3.1 8.2 0 11.3l39.6 39.6c3.1 3.1 8.2 3.1 11.3 0l226.4-226.4c3.1-3.1 3.1-8.2 0-11.3l-39.5-39.6z' fill='%23aaa'/%3E%3C/svg%3E\");width:20px;height:20px;background-size:contain;background-repeat:no-repeat;background-position:50%;vertical-align:-6px;cursor:pointer}.icon-copy:hover{background-image:url(\"data:image/svg+xml;charset=utf-8,%3Csvg class='icon' viewBox='0 0 1024 1024' xmlns='http://www.w3.org/2000/svg' width='200' height='200'%3E%3Cpath d='M574 665.4c-3.1-3.1-8.2-3.1-11.3 0L446.5 781.6c-53.8 53.8-144.6 59.5-204 0-59.5-59.5-53.8-150.2 0-204l116.2-116.2c3.1-3.1 3.1-8.2 0-11.3l-39.8-39.8c-3.1-3.1-8.2-3.1-11.3 0L191.4 526.5c-84.6 84.6-84.6 221.5 0 306s221.5 84.6 306 0l116.2-116.2c3.1-3.1 3.1-8.2 0-11.3L574 665.4zm258.6-474c-84.6-84.6-221.5-84.6-306 0L410.3 307.6c-3.1 3.1-3.1 8.2 0 11.3l39.7 39.7c3.1 3.1 8.2 3.1 11.3 0l116.2-116.2c53.8-53.8 144.6-59.5 204 0 59.5 59.5 53.8 150.2 0 204L665.3 562.6c-3.1 3.1-3.1 8.2 0 11.3l39.8 39.8c3.1 3.1 8.2 3.1 11.3 0l116.2-116.2c84.5-84.6 84.5-221.5 0-306.1zM610.1 372.3c-3.1-3.1-8.2-3.1-11.3 0L372.3 598.7c-3.1 3.1-3.1 8.2 0 11.3l39.6 39.6c3.1 3.1 8.2 3.1 11.3 0l226.4-226.4c3.1-3.1 3.1-8.2 0-11.3l-39.5-39.6z' fill='%231296db'/%3E%3C/svg%3E\")}", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    domProps: {
      "checked": Array.isArray(_vm.useDir) ? _vm._i(_vm.useDir, null) > -1 : (_vm.useDir)
    },
    on: {
      "change": function($event) {
        ...
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$el.checked) {
            $$i < 0 && (_vm.useDir = $$a.concat([$$v]))
          } else {
            $$i > -1 && (_vm.useDir = $$a.slice(0, $$i).concat($$a.slice($$i + 1)))
          }
        } else {
          _vm.useDir = $$c
        }
  ...
  }, [_vm._v(_vm._s(_vm.isfetching ? '停止下载' : '开始下载'))]), _vm._v(" "), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.parallelNum),
      expression: "parallelNum"
    }],
    staticStyle: {
      "margin-left": "50px"
    },
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.parallelNum = $event.target.value
      }
    }
  }), _vm._v(" "), _c('div', [_vm._v("下载中的图片")]), _vm._v(" "), _c('div', {
    staticClass: "list-block",
    attrs: {
      "id": "fetching-list"
    }
  }, _vm._l((_vm.fetchingList), function(item, index) {
    return _c('taskitem', {
      attrs: {
        "url": item
      }
    })
  }), 1), _vm._v(" "), _c('br'), _vm._v(" "), _c('div', [_vm._v("未获取的图片"), _c('span', {
    attrs: {
  ...
  }), 1), _vm._v(" "), _c('br'), _vm._v(" "), _c('div', [_vm._v("获取失败的图片 "), _c('span', {
    attrs: {
  ...
  }), 1), _vm._v(" "), _c('br'), _vm._v(" "), _c('div', [_vm._v("获取完成的图片"), _c('span', {
    attrs: {
...
var update = __webpack_require__(2)("d1308c88", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("49085c1b", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("30991260", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("8fe1d4f0", content, true);
