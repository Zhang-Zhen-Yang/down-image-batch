...
// module
exports.push([module.i, ".download-btn{width:30px;height:35px;line-height:35px;color:#fff;border-radius:3px 0 0 3px;background-color:#007acc;position:fixed;right:0;top:200px;cursor:pointer;text-align:center}", ""]);
